...
def generate_script(tool_config, variables, output_dir):
    ...
    with open(script_file, 'w') as f:
        ...
        try:
            date_result = subprocess.run(['date'], capture_output=True, text=True, timeout=2)
            f.write(f"# Generated on: {date_result.stdout.strip()}\n\n")
        except:
            f.write("# Generated by Pathfinder\n\n")
        ...
        for arg in cmd:
            if ' ' in arg or '"' in arg or "'" in arg:
                ...
                escaped_cmd.append(f"'{arg.replace(chr(39), chr(39)+chr(92)+chr(39)+chr(39))}'")
            else:
...
{Style.RESET_ALL}"""
    ...
    print(f"{Fore.CYAN}[*] Script generation complete.")
    
    if args.generate_scripts_only:
        print(f"{Fore.CYAN}[*] Tools NOT executed (--generate-scripts-only flag).")
        return
